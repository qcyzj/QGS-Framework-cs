...
namespace Share.Net.Sessions
{
    public abstract class Session
    {
        ...
        public delegate void ManagerRemoveObject(Session sess);
        ...
        private static ManagerRemoveObject m_RemoveObjectFunc;
        ...
        public static void SetManagerRemoveFunc(ManagerRemoveObject func)
        {
            Debug.Assert(null == m_RemoveObjectFunc);
            m_RemoveObjectFunc = func;
        }
    }
}
